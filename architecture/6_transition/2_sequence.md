...
| 2 — Databricks (initiative 13, built 2026-09-09; the workspace run pending) | `GAP1`, `GAP2` | `PLAT2` | A workspace with a SQL warehouse, a dev catalog and Apps enabled; a service principal | The same app on Databricks Apps, the same data in a Unity Catalog schema, the same tests green |
