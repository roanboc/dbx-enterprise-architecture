...
opened by [initiative 22](../scope/22_proposal-templates-revisions-and-impact.md); `GAP24` and
`GAP25` opened by [initiative 23](../scope/23_proposals-refined-in-conversation.md). The
