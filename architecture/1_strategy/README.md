...
The top-down context: who has a stake in the repository, why it exists, and
which principles every change is checked against; and, since the processes
exist, the one value stream the repository serves and the capability it
realises. The enterprise's own capabilities and value streams are content
*inside* the repository, not this application's strategy.
