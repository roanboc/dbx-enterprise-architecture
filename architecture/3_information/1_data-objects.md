...
| `DOBJ3.12` | ▤ «Data Object» Connected system | `DOBJ1.1` | ▤ «Data Object» Element type | speaks for | the types it masters; what it says about their elements is read, never loaded |
| `DOBJ3.12` | ▤ «Data Object» Connected system | `DOBJ2.3` | ▤ «Data Object» Element link | answers for | the link addresses it can read, so a deep dive reads the page an element links to |
| `DOBJ3.11` | ▤ «Data Object» Deep dive | `DOBJ3.12` | ▤ «Data Object» Connected system | cites | what the system said, with its own reference and when it was read |
| `DOBJ2.8` | ▤ «Data Object» Organisation | `DOBJ3.12` | ▤ «Data Object» Connected system | holds | each organisation connects its own |
