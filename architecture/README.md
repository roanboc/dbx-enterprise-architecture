...
| 3 | Information | What information exists, and where does it live? | `Local` — [3_information/](./3_information/README.md): the metamodel in versions, the architecture graph partitioned by organisation, the exchange files and the audit trail; `◐` |
