...
| [0023](./0023-the-model-is-served-by-the-platform.md) | The assistant's model is a Model Serving endpoint, reached over its Messages API | Adopted 2026-09-24, at the Requester's word (initiative 24) | `ACMP5`, `ACMP10`, `TSVC7`, `ART6`, `GAP25` |
