...
MM_PALETTE = "mm-palette"  # the metamodel as a draw.io shape library (initiative 26)
...
SYS_CONNECTION = "sys-connection"  # a Unity Catalog MCP connection of the workspace, picked
