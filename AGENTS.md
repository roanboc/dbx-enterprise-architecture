...
uv run ea --help # the CLI: init, load-pack, export-pack, import, export, validate, find, get, set, neighbours, trace, impact, view, target, health, sql, summary, branch …, reviewers …, metamodel …, org …, feed …; --branch, --as and --org on any command
```
