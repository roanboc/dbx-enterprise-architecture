...
uv run ea --help # the CLI: init, load-pack, export-pack, import, export, validate, stats, find, get, set, neighbours, trace, impact, view, viewpoints, target, health, sql, summary, branch …, reviewers …, metamodel …, org …, feed …, runs …; --branch, --as and --org on any command
```
